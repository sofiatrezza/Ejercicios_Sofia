...
peso_payaso = 112
peso_muñeca = 75
cant_payaso = int(input("Ingrese la cantidad de payasos pedidos: "))
cant_muñecas = int(input("Ingrese la cantidad de muñecas pedidas: "))
peso_paquete = (peso_payaso*cant_payaso) + (peso_muñeca*cant_muñecas)
print(f"El peso total del paquete que sera enviado es de {peso_paquete} gr")